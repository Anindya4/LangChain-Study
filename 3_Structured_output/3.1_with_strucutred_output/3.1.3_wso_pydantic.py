...
class Review(BaseModel):
    ...
    sentiment : Literal["pos", "neg"] = Field(description="Sentement of the review either positive, negative or neutral")
    pros : Optional[list[str]]= Field(default=None, description="Write down the pros mentioned in review inside a list")
    cons : Optional[list[str]] = Field(default=None, description="Write down the cons mentioned in review inside a list") 
    name : Optional[str] = Field(default=None, description="The reviewer's name")
